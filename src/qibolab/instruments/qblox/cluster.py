...
class QbloxSweeper:
    ...
    Attributes:
        ...
        register (:class:`qibolab.instruments.qblox.q1asm.Register`): the main Register (q1asm variable) used in the loop.
        aux_register (:class:`qibolab.instruments.qblox.q1asm.Register`): an auxialiry Register requried in duration
            sweeps.
    ...
    Methods:
        block(inner_block: :class:`qibolab.instruments.qblox.q1asm.Block): generates the block of q1asm code that implements
            the sweep.
    """
    ...
    def from_sweeper(
        ...
        Args:
            program (:class:`qibolab.instruments.qblox.q1asm.Program`): a program object representing the q1asm program of a
                sequencer.
    ...
    def __init__(
        ...
        Args:
            program (:class:`qibolab.instruments.qblox.q1asm.Program`): a program object representing the q1asm program
                of a sequencer.
    ...
    def block(self, inner_block: Block):
        ...
        Args:
            inner_block (:class:`qibolab.instruments.qblox.q1asm.Block): the block of q1asm code to be repeated within
                the loop.
    ...
    def connect(self):
        ...
        if not self.is_connected:
            if cluster:
                ...
                self.local_oscillators["o1"] = type(
                    f"local_oscillator_o1",
                    (),
                    {
                        "frequency": self.property_wrapper("out0_in0_lo_freq"),
                    },
                )()
        ...
        if not self.is_connected:
            if cluster:
                ...
                for n in range(2):
                    ...
                    self.local_oscillators[port] = type(
                        f"local_oscillator_" + port,
                        (),
                        {
                            "frequency": self.property_wrapper(f"out{n}lo_freq"),
                        },
                    )()
